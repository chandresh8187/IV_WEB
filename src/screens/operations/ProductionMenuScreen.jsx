...
export default function ProductionMenuScreen(){
  ...
  const actions=[
    ...
    {title:"Chemical Tracking",icon:FlaskConical,path:"/production/chemical-tracking",description:"Record flux temperature and daily flux and acid readings.",show:allowed("chemical_checks.view")},
