...
const titles={"/dashboard":"Dashboard","/production":"Production","/production/live":"Live Production","/production/chat":"Plant Chat","/production/planning":"Production Planning","/production/history":"Production History","/production/rate-calculator":"Rate Calculator","/production/contract-production":"Contract Production","/production/expenses":"Expense Report","/production/monthly-reports":"Monthly Reports","/production/zinc-stock":"Zinc Stock","/production/shift":"Shift Status","/production/certificates":"Test Certificate","/production/plant":"Plant Control","/settings":"Settings","/settings/items":"Items","/settings/contractors":"Contractors","/settings/financial-years":"Financial Year","/settings/user-access":"User Access","/settings/control-panel":"Control Panel","/profile":"Profile"};
...
export default function AppLayout(){
  ...
  const parentPath=location.pathname==="/production/chat"?"/production/live":location.pathname.startsWith("/production/")?"/production":location.pathname.startsWith("/settings/")?"/settings":["/production","/settings","/profile"].includes(location.pathname)&&role!=="supervisor"?"/dashboard":null;
